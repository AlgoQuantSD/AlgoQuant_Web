      ...
      <div className="flex self-stretch">
        ...
        <div className="sm:w-3/4 md:w-5/6 lg:w-7/8 p-5">
          ...
          <div className="flex w-full mt-10 h-3/4">
            <Link
              to="/createai"
              className="flex flex-col justify-center items-center w-1/2 h-full bg-gold hover:bg-selection-gold"
            >
              <div>
            ...
            <Link
              to="/createstandard"
              className="flex flex-col justify-center items-center w-1/2 h-full bg-green hover:bg-selection-green"
            >
              <div>
